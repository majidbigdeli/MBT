...
using Hik.Samples.Mbt.IrcChat.Exceptions;

namespace Hik.Samples.Mbt.IrcChat.Server
{
    /// <summary>
    /// This class implements Chat Service Contract.
    /// </summary>
    internal class ChatService : MbtService, IChatService
    {
        ...
        {
            //Get client object
            var client = (IMbtServiceClient)sender;
        ...
        private sealed class ChatClient
        {
            ...
            /// </summary>
            /// <param name="client">Mbt client reference</param>
            ...
            public ChatClient(IMbtServiceClient client, IChatClient clientProxy, UserInfo userInfo)
            {
                Client = client;
