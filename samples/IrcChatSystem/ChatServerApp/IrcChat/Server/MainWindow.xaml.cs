...
namespace Hik.Samples.Mbt.IrcChat.Server
{
    ...
    {
        /// <summary>
        /// This object is used to host Chat Service on a MBT server.
        /// </summary>
        private IMbtServiceApplication _serviceApplication;
        ...
        private void btnStartServer_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                _serviceApplication = MbtServiceBuilder.CreateService(new MbtTcpEndPoint(port));
