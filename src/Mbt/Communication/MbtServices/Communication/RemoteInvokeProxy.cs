...
namespace Hik.Communication.MbtServices.Communication
{
    /// <summary>
    ...
    internal class RemoteInvokeProxy<TProxy, TMessenger> : RealProxy where TMessenger : IMessenger
    {
        ...
        public override IMessage Invoke(IMessage msg)
        {
            ...
            var requestMessage = new MbtRemoteInvokeMessage
            {
            ...
            var responseMessage = _clientMessenger.SendMessageAndWaitForResponse(requestMessage) as MbtRemoteInvokeReturnMessage;
