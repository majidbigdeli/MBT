...
namespace Hik.Communication.Mbt.Communication.Channels
{
    /// <summary>
    ...
    internal abstract class CommunicationChannelBase : ICommunicationChannel
    {
        ...
        ///</summary>
        public abstract MbtEndPoint RemoteEndPoint { get; }
        ...
        /// </summary>
        public IMbtWireProtocol WireProtocol { get; set; }
        ...
        /// </summary>
        /// <param name="message">Message to be sent</param>
        protected abstract void SendMessageInternal(IMbtMessage message);
