...
namespace Hik.Communication.Mbt.Communication.Channels.Tcp
{
    /// <summary>
    ...
    internal class TcpCommunicationChannel : CommunicationChannelBase
    {
        ...
        ///</summary>
        public override MbtEndPoint RemoteEndPoint
        {
            get
            {
        ...
        private readonly MbtTcpEndPoint _remoteEndPoint;
        ...
        public TcpCommunicationChannel(Socket clientSocket)
        {
            ...
            _remoteEndPoint = new MbtTcpEndPoint(ipEndPoint.Address.ToString(), ipEndPoint.Port);
        ...
        protected override void SendMessageInternal(IMbtMessage message)
        {
            //Send message
            var totalSent = 0;
            lock (_syncLock)
