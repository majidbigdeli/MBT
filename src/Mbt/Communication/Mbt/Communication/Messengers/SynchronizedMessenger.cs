...
namespace Hik.Communication.Mbt.Communication.Messengers
{
    ...
    public class SynchronizedMessenger<T> : RequestReplyMessenger<T> where T : IMessenger
    {
        ...
        /// </summary>
        private readonly Queue<IMbtMessage> _receivingMessageQueue;
            ...
            : base(messenger)
        {
            ...
            _receivingMessageQueue = new Queue<IMbtMessage>();
        ...
        public IMbtMessage ReceiveMessage()
        {
        ...
        public IMbtMessage ReceiveMessage(int timeout)
        {
            while (_running)
            {
                lock (_receivingMessageQueue)
        ...
        /// </summary>
        /// <returns>Received message</returns>
        public TMessage ReceiveMessage<TMessage>() where TMessage : IMbtMessage
        {
        ...
        /// </param>
        /// <returns>Received message</returns>
        public TMessage ReceiveMessage<TMessage>(int timeout) where TMessage : IMbtMessage
        {
        ...
        protected override void OnMessageReceived(IMbtMessage message)
        {
            lock (_receivingMessageQueue)
            {
