...
namespace Hik.Communication.Mbt.Communication.Messengers
{
    /// <summary>
    ...
    public class RequestReplyMessenger<T> : IMessenger, IDisposable where T : IMessenger
    {
        ...
        /// </summary>
        private readonly SequentialItemProcessor<IMbtMessage> _incomingMessageProcessor;
        ...
        public RequestReplyMessenger(T messenger)
        {
            ...
            _incomingMessageProcessor = new SequentialItemProcessor<IMbtMessage>(OnMessageReceived);
        ...
        public IMbtMessage SendMessageAndWaitForResponse(IMbtMessage message)
        {
        ...
        public IMbtMessage SendMessageAndWaitForResponse(IMbtMessage message, int timeoutMilliseconds)
        {
        ...
        protected virtual void OnMessageReceived(IMbtMessage message)
        {
        ...
        private sealed class WaitingMessage
        {
            ...
            /// </summary>
            public IMbtMessage ResponseMessage { get; set; }
