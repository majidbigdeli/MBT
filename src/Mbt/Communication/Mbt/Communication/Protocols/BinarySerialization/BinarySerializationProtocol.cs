...
namespace Hik.Communication.Mbt.Communication.Protocols.BinarySerialization
{
    ...
    /// </summary>
    public class BinarySerializationProtocol : IMbtWireProtocol
    {
        ...
        #region IMbtWireProtocol implementation
        ...
        public byte[] GetBytes(IMbtMessage message)
        {
        ...
        /// </returns>
        public IEnumerable<IMbtMessage> CreateMessages(byte[] receivedBytes)
        {
            ...
            var messages = new List<IMbtMessage>();
        ...
        /// </returns>
        protected virtual byte[] SerializeMessage(IMbtMessage message)
        {
        ...
        protected virtual IMbtMessage DeserializeMessage(byte[] bytes)
        {
            ...
            using (var deserializeMemoryStream = new MemoryStream(bytes))
            {
                ...
                try
                {
                    ...
                    return (IMbtMessage)binaryFormatter.Deserialize(deserializeMemoryStream);
                }
        ...
        /// </returns>
        /// <exception cref="CommunicationException">Throws CommunicationException if message is bigger than maximum allowed message length.</exception>
        private bool ReadSingleMessage(ICollection<IMbtMessage> messages)
        {
