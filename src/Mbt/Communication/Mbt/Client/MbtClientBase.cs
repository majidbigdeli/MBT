...
namespace Hik.Communication.Mbt.Client
{
    ...
    /// </summary>
    internal abstract class MbtClientBase : IMbtClient
    {
        ...
        private IMbtWireProtocol _wireProtocol;
        ...
        {
            if (e.Message is MbtPingMessage)
            {
                return;
            }
        ...
        private void PingTimer_Elapsed(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                _communicationChannel.SendMessage(new MbtPingMessage());
            }
